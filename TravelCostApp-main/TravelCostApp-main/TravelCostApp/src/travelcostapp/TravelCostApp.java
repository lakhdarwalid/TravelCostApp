...
public class TravelCostApp {
    ...
    static JFrame frame;
        ...
        static JMenu file;
        static JMenuItem calcItem;
        static JMenuItem clearItem;
    ...
    public static void main(String[] args) {
        ...
        calcItem = new JMenuItem("Calculate");
        calcItem.addActionListener(new CalculateCostListener());
        clearItem = new JMenuItem("Clear");
        clearItem.addActionListener(new ClearFileds());
    ...
    static class CalculateCostListener implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            String r = dc.format(travelCost.getTotalCost());
            Result.setText(r);
            }
